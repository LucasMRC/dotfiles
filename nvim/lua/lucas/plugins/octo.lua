return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>op", ":Octo search repo:grafana/website is:open is:pr author:@me archived:false<CR>", { noremap = true, silent = true, desc = "[O]cto [P]R mine list"})
        vim.keymap.set("n", "<leader>or", ":Octo search repo:grafana/website is:open is:pr archived:false<CR>", { noremap = true, silent = true, desc = "[O]cto [R]eview requested list"})
        vim.keymap.set("n", "<leader>oi", ":Octo search repo:grafana/website is:open is:issue assignee:@me archived:false<CR>", { noremap = true, silent = true, desc = "[O]cto [I]ssues assigned list"})
        vim.keymap.set("n", "<leader>om", ":Octo search repo:grafana/website is:open is:issue author:@me archived:false<CR>", { noremap = true, silent = true, desc = "[O]cto [M]y issues list"})
